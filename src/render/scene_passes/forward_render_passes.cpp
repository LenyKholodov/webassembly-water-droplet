...
struct ForwardLightingPass : IScenePass
{
  public:
    ...
    {
      // procedural flowers: opaque, depth-tested, two-sided (petals are single-strip surfaces)
      ...
      pass_group.add_pass("flower", flower_pass, 0);   // procedural flowers (vertex-colour lit)
