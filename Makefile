...
LINK_FLAGS += -s USE_BULLET=1 -sALLOW_MEMORY_GROWTH
...
CC_FLAGS += -O3 -Wbad-function-cast -Wcast-function-type -s USE_SDL=2  -sUSE_SDL_IMAGE=2 -s SDL2_IMAGE_FORMATS='["png","jpg"]'
